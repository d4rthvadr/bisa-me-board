...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'board.context_processors.theme',
            ],
        },
    },
]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'qna_board'),
        'USER': os.environ.get('DB_USER', 'qna_board'),
...
LOGIN_URL = 'board:sign_in'
LOGIN_REDIRECT_URL = 'board:owner_boards'
